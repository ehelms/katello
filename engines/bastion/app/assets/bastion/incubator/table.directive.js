 ...
 */
angular.module('alchemy').directive('alchTableHead', ['$parse', function($parse) {
 ...
 */
angular.module('alchemy').directive('alchTableCell', ['$compile', function($compile) {
    return {
    ...
    return {
        ...
        compile: function(tElement, tAttrs) {
            var table = tElement.find('table').clone(),
                tableHeader = angular.element(table).find('tbody').remove();
